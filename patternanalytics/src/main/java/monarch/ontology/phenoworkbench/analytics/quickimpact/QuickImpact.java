...
import monarch.ontology.phenoworkbench.analytics.pattern.*;
...
public class QuickImpact {
    ...
    public Optional<Explanation> getSubsumptionExplanation(PatternClass c, PatternClass p) {
        return r.getExplanation(c.getOWLClass(),p.getOWLClass());
    }

    public Optional<ExplanationAnalyser> getSubsumptionExplanationRendered(PatternClass c, PatternClass p) {
        Optional<Explanation> explanation = getSubsumptionExplanation(c,p);
