...
public class PatternGenerator {
    ...
    PatternGenerator(RenderManager renderManager) {
    ...
    private PatternGrammar generateGrammar(OWLClassExpression definition) {
        OWLClassExpression ce = replaceClassesInSignatureWith(definition,df.getOWLClass(IRI.create(PatternIRIs.EBIBASE+"X")));
